...
window.NORSE_STOPS = [
  ...
  ['h-sicily','harald','Aci Castello · Sicily',37.5545,15.1462,'illustrative','City anchor','Aci Castello, the stop the postcard and its postmark carry. The evidence tier drops to illustrative on purpose: Harald’s own Sicilian service is attested at Syracuse and Messina under George Maniakes in 1038-1040, not here, and the castle on the lava rock is Norman, built around 1076 -- a decade after Harald died. Sicily is on the trail because of the Maniakes campaign; this particular town is where Liv stayed. Chosen 20 Sept 2026 over moving the stop to Syracuse, which would have meant new front art, a new postmark and a rewritten card. The source below still explains why Sicily is here at all.','haraldSyracuse'],
