...
def draw_front_card(c, x=0, y=0):
    ...
    if (fw, fh) != (1500, 1050):
        raise ValueError(
            f"Postcard_A2_Hvammur_Front.png is {fw}x{fh}, expected 1500x1050 (PC-13, "
...
def draw_back_card(c, x=0, y=0):
    ...
    # Message rewritten 19 Sept 2026 (PZ-17): resolves the "village at the crossing" leg,
    ...
    c.drawCentredString(postmark_x, postmark_y - 1, "HVAMMUR")
    ...
    # Fun Fact -- typed, real trivia (PC-12). Drafted 16 Sept 2026; see stops.js a-hvammur.
    ...
    credit_lines = [
        "Sourced via Wikipedia and Guide to Iceland (see PZ-17 for links).",
    ]
...
def build_single():
    ...
    c.setTitle("Aunt Liv's Postcard A2 - Hvammur")
...
def build_letter():
    ...
    c.setTitle("Two-up Postcard A2 print sheet - Hvammur")
    c.setAuthor("Escape Backpack")
